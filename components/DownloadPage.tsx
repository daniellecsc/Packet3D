...
function Card({ icon, os, description, href }: cardProps) {
  return (
    <div className='bg-white-panels/15 backdrop-blur-sm hover:bg-white-panels/25 w-full flex flex-col lg:w-[300px] lg:h-[280px] md:h-[250px] rounded-2xl p-4 lg:p-4 relative md:w-[250px] overflow-hidden z-20 gap-2 md:gap-0 transition-all duration-200 ease-in-out'>
      <div className='w-full'>
        <div className='flex justify-center items-center h-14 w-14 rounded-full bg-teal-panel_inactive shadow-md'>
          {icon}
        </div>
      </div>
...
export default function DownloadPage() {
  return (
    <section className='relative bg-darkTeal-bgColor padding-container md:h-lvh h-fit flex flex-col gap-16 py-10 pb-32 lg:py-20 justify-center items-center overflow-hidden'>
      ...
      <div className='relative w-full flex justify-center items-center gap-10 z-10 mt-2 md:flex-row flex-col'>
        ...
        <Card
          icon={
            <FaApple className='text-center text-2xl text-white-panels drop-shadow-lg' />
          }
          os={'MacOS'}
          description={'Download Packet3D for MacOS'}
          href={''}
        />
        <Card
          icon={
